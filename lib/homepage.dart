    ...
    return Scaffold(
      body: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        const Text('seamlessly',
            style: TextStyle(fontSize: 20, color: Colors.white)),
        const SizedBox(height: 20),
      const SizedBox(height: 100,),  Column(
          children: [
            Container(
              width: 480,
              height: 50,
                ...
                child: Row(
                  ...
                  children: [
                    SizedBox(
                      height: 20,
                      width: 30,
                      child: Image.network('https://w7.pngwing.com/pngs/344/344/png-transparent-google-logo-google-logo-g-suite-google-text-logo-symbol.png'),
                    ),
                    const Text(
                      'Sign Up with Google',
                      style: TextStyle(
